...
|---------------|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0             | int      | File Header, must always be 0xAA55AA555                                                                                                                                                                                                                                                                                                                               |
| 4             | int      | File version, this guide covers 105, which matches patch 3.1.91636 and higher                                                                                                                                                                                                                                                                                         |
| 8             | int      | file size                                                                                                                                                                                                                                                                                                                                                             |
| 12            | int      | checksum                                                                                                                                                                                                                                                                                                                                                              |
| 16            | int      | unknown                                                                                                                                                                                                                                                                                                                                                               |
...
| 28            | int      | unknown                                                                                                                                                                                                                                                                                                                                                               |
| 32            | int      | Time stamp.  This is in the standard time() format of the number of seconds which have elapsed since midnight, January 1, 1970 (UTC).                                                                                                                                                                                                                                 |
| 36            | int      | unknown                                                                                                                                                                                                                                                                                                                                                               |
...
| 155           | long     | Map ID                                                                                                                                                                                                                                                                                                                                                                |
| 161           | short    | Mercenary flags, although only '1' is used on the first bit in case the mercenary is dead and requires resurrection for a fee                                                                                                                                                                                                                                         |
| 163           | int      | Mercenary seed ID, random every time you purchase a new mercenary                                                                                                                                                                                                                                                                                                     |
| 167           | short    | Mercenary name id (can be retrieved from mercenaries.json)                                                                                                                                                                                                                                                                                                            |
| 169           | short    | Mercenary type code (will add the list in a separate file, a reference is also available for [1.09 here](https://user.xmission.com/~trevin/DiabloIIv1.09_Mercenaries.html#code)                                                                                                                                                                                       |
| 171           | long     | Mercenary XP - the value varies depending on the merc leveling up by him/herself, or when you re-purchase them in town                                                                                                                                                                                                                                                |
